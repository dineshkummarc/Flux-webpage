...
CREATE TABLE project (id BIGINT AUTO_INCREMENT, unit_id BIGINT NOT NULL, enumeration_id BIGINT NOT NULL, logo VARCHAR(255), alt_image VARCHAR(255), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX unit_id_idx (unit_id), INDEX enumeration_id_idx (enumeration_id), PRIMARY KEY(id)) ENGINE = INNODB;
