...
FLTxt = {
	...
	projectes : [
        ...
        "<h1>Proyectos</h1><p><strong><a href='http://www.skaeda.com'><u>Skaeda</u></a></strong></p><p>Es un gestor personal de enlaces a páginas web favoritas (<em>bookmarks</em>) con las siguientes características:</p><ul><li>Organización por carpetas inteligentes</li><li>previsualitzación de enlaces con miniatura</li><li>etiquetaje social independiente del idioma</li><li>aplicación web en tiempo real verdadera</li></ul>",
        "<h1>Projects</h1>"],
	bitacora : [
        "<h1>Bitàcora</h1>",
        "<h1>Bitácora</h1>",
