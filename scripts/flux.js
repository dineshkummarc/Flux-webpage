...
FLTxt = {
	...
	manifest : [
	  ...
	  "<h1>Manifest</h1>"],
	projectes : [
        "<h1>Projectes</h1><p><strong><a href='http://www.skaeda.com'><u>Skaeda</u></a></strong></p><p>Es un gestor personal d'enllaços a pàgines web favorites (<em>bookmarks</em>) amb les característiques següents:<ul><li>Organització per carpetes intel·ligents</li><li>previsualització d'enllaços amb miniatura</li><li>etiquetatge social independent de l'idioma</li><li>aplicació web en temps real verdadera</li></ul></p>",
        "<h1>Proyectos</h1><p><strong><a href='http://www.skaeda.com'><u>Skaeda</u></a></strong></p><p>Es un gestor personal de enlaces a páginas web favoritas (<em>bookmarks</em>) con las siguientes características:<ul><li>Organización por carpetas inteligentes</li><li>previsualitzación de enlaces con miniatura</li><li>etiquetaje social independiente del idioma</li><li>aplicación web en tiempo real verdadera</li></ul></p>",
        "<h1>Projects</h1>"],
	bitacora : [
        "<h1>Bitàcora</h1>",
        "<h1>Bitácora</h1>",
